...
public class BaseClass {
    ...
    public WebDriver conexionBrowser(@NotNull String browser, String propertyDriver, String rutaDriver){
        switch (browser){
            case "CHROME":
    ...
    //click
    public void click(@NotNull WebElement elemento){
        elemento.click();
    }
    ...
    //obtenerTexto
    public String obtenerTexto(@NotNull WebElement elemento){
    ...
    //agregarTexto
    public void agregarTexto(@NotNull WebElement elemento, String texto){
